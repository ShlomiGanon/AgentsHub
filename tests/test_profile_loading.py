"""Profile loading, validation, and classification registries."""
...
from profiles import AreaRegistry, build_area_registry
...
from profiles import EventTypeRegistry, build_event_type_registry
...
def test_response_team_profile_declares_area_required_for_its_flagged_event_types(
