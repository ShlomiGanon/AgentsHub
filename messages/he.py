...
>>>>>>> feat/FinalProfiles
    ...
    "admin.menu_units": "יחידות מבצעיות",
    "admin.units_title": "הגדרות יחידה",
    "admin.units_subtitle": "הגדרת יחידת ה־LIVE והפרופיל המבצעי המהימן שלה.",
    "admin.unit_name": "שם היחידה",
    "admin.unit_type": "סוג היחידה",
    "admin.unit_response_team": "כיתת כוננות",
    "admin.unit_fire_station": "כבאות והצלה",
    "admin.unit_status": "סטטוס",
    "admin.unit_pending": "ממתינה להגדרה",
    "admin.unit_active": "פעילה",
    "admin.unit_save": "שמירת הגדרות יחידה",
    "admin.unit_created": "היחידה המבצעית נשמרה.",
    "admin.unit_invalid": "הגדרת היחידה אינה תקינה: {reason}",
    "admin.unit_none": "טרם הוגדרה יחידת LIVE.",
    "admin.unit_current": "יחידת LIVE נוכחית",
    "admin.unit_roles": "תפקידים תואמים",
    "admin.unit_members": "חברויות ביחידה",
    "admin.membership_unit": "יחידה מבצעית",
    "admin.membership_role": "תפקיד",
    "admin.membership_status": "סטטוס חברות",
    "admin.membership_pending": "ממתין לקליטה",
    "admin.membership_active": "פעילה",
    "admin.membership_assign": "שיבוץ ואישור",
    "admin.membership_required": "יש לבחור יחידה ותפקיד תואם לפני האישור.",
    "admin.membership_assigned": "המשתמש {identity} שובץ ב־{unit} בתפקיד {role}.",
    "admin.membership_no_simulation": "זהות סימולציה אינה יכולה להשתייך ליחידת LIVE.",
    ...
    "admin.simulator.binding_title": "קישור טלגרם לסימולציה",
    "admin.simulator.binding_help": "קשר זהות טלגרם מהימנה לריצה המדויקת שנטענה.",
    "admin.simulator.binding_identity": "זהות טלגרם",
    "admin.simulator.binding_bind": "קשר לריצה המדויקת",
    "admin.simulator.binding_unbind": "הסר קישור",
    "admin.simulator.binding_bound": "מקושר אל {scenario_id}/{run_id}",
    "admin.simulator.binding_unbound": "ללא קישור",
    "admin.simulator.binding_load_first": "טען ריצה מדויקת והזן זהות טלגרם.",
    "admin.simulator.binding_failed": "הקישור נכשל: {message}",
