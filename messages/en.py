...
MESSAGES = {
    ...
    "response_team.friendly_forces.confirm_police": "Police force dispatch to '{location}' recorded successfully.",
    "response_team.friendly_forces.log_ambulance": "EMS dispatched to '{location}': casualties={count}",
    "response_team.friendly_forces.log_firefighters": "Firefighters dispatched to '{location}': vehicles={count}",
    "response_team.friendly_forces.log_military": "Military force dispatched to '{location}': units={count}",
    "response_team.friendly_forces.log_police": "Police dispatched to '{location}': units={count}",
    "response_team.friendly_forces.role": "Responsible for coordinating and dispatching security and emergency forces (police, EMS, firefighters, military).",
    "response_team.friendly_forces.system_prompt": "You are a specialist agent for coordinating and dispatching security and emergency forces (police, EMS, firefighters, military). "
    ...
    "response_team.friendly_forces.tool.ambulance": "Records an EMS/medical force dispatch to the requested target.",
    "response_team.friendly_forces.tool.firefighters": "Records a firefighting/rescue force dispatch to the requested target.",
    "response_team.friendly_forces.tool.military": "Records a military and security force dispatch to the requested target.",
    "response_team.friendly_forces.tool.police": "Records a police force dispatch to the requested target.",
    "response_team.keyboard.approvals_queue": "{icon} תור אישורים",
    "response_team.keyboard.available": "{icon} אני זמין לכוננות",
    "response_team.keyboard.camera_status": "{icon} מצב מצלמות",
    "response_team.keyboard.dispatch_drone": "{icon} הזנקת רחפן",
    "response_team.keyboard.dispatch_forces": "{icon} הזנקת כוחות",
    "response_team.keyboard.drone_fleet_status": "{icon} מצב צי רחפנים",
    "response_team.keyboard.event_history": "{icon} היסטוריית אירועים",
    "response_team.keyboard.overall_picture": "{icon} תמונת מצב כללית",
    "response_team.keyboard.recall_drone": "{icon} החזרת רחפן לבסיס",
    "response_team.keyboard.team_status": "{icon} סטטוס כיתת כוננות",
    "response_team.keyboard.unavailable": "{icon} איני זמין",
    "response_team.seed.commander_user_name": "Readiness Team Commander",
    "response_team.seed.member_1001": "Dan Levi",
    "response_team.seed.member_1002": "Yossi Cohen",
    "response_team.seed.member_1003": "Michal Avraham",
    "response_team.seed.primary_name": "Commander / Primary User",
    "response_team.seed.viewer_user_name": "Readiness Team Member",
    "response_team.simulation.response_team_label": "Simulated response team",
    "response_team.simulation.sec001.chat.cameras.label": "Camera Hub",
    "response_team.simulation.sec001.chat.commander_dm.label": "Private chat with the security officer",
    "response_team.simulation.sec001.chat.external_forces.label": "External Forces",
    "response_team.simulation.sec001.chat.response_team.label": "Response Team",
    "response_team.simulation.sec001.group.cameras.label": "Camera Hub",
    "response_team.simulation.sec001.group.external_forces.label": "External Forces",
    "response_team.simulation.sec001.persona.dan_response_team": "Dan - Response Team",
    "response_team.simulation.sec001.persona.danny_response_team": "Danny - Response Team",
    "response_team.simulation.sec001.persona.eli_response_team": "Eli - Response Team",
    "response_team.simulation.sec001.persona.gil_response_team": "Gil - Response Team",
    "response_team.simulation.sec001.persona.mda_dispatch": "MDA Dispatch (Magen David Adom)",
    "response_team.simulation.sec001.persona.michael_response_team": "Michael - Response Team",
    "response_team.simulation.sec001.persona.patrol_unit_40": "Patrol Unit 40",
    "response_team.simulation.sec001.persona.police_duty_officer": "Police Station Duty Officer",
    "response_team.simulation.sec001.persona.police_patrol": "Police Patrol",
    "response_team.simulation.sec001.persona.resident_avraham": "Resident - Avraham (Expansion Neighborhood)",
    "response_team.simulation.sec001.persona.sdemot_security_coordinator": "Sdemot Hub - Neighboring Security Coordinator",
    "response_team.simulation.sec001.persona.site_security_officer": "Site Security Officer",
    "response_team.simulation.sec001.persona.yasam_commander": "Special Patrol Unit (YASAM) Commander - Police",
    "response_team.simulation.sec001.persona.yossi_technician": "Yossi - Contract Technician",
    "response_team.simulation.sec001.persona.yuval_response_team": "Yuval - Response Team",
    "response_team.simulation.sec001.phase1.description": "Collecting daily roster data, minor network faults and maintenance, and perimeter reports with no defined threat.",
    "response_team.simulation.sec001.phase1.step1.text": "Good morning, just letting you know I'm on reserve duty from Sunday through Tuesday evening - unavailable in the community.",
    "response_team.simulation.sec001.phase1.step2.text": "CAM-03 (south corner) is showing intermittent reception interference. Might just be a branch blocking the view or a focus issue.",
    "response_team.simulation.sec001.phase1.step3.text": "To the whole sector: a small fire in open ground near the regional access road. Fire and rescue are handling it, no risk to agricultural land.",
    "response_team.simulation.sec001.phase1.step4.text": "Guys, I got a new phone. The new number is updated - checking in during tonight's quiet shift.",
    "response_team.simulation.sec001.phase1.step5.text": "Good evening, put together a daily summary for me: who's missing from tonight's roster, and what's the status of the perimeter-fence cameras?",
    "response_team.simulation.sec001.phase1.step6.text": "I woke up with a high fever, I won't be able to join this evening's patrol.",
    "response_team.simulation.sec001.phase1.step7.text": "CAM-01 (east fence, section 4) has been deliberately taken down for two hours for a routine version update.",
    "response_team.simulation.sec001.phase1.step8.text": "Sector update: last night an ATV was stolen from our side. High likelihood the thieves moved along the perimeter route.",
    "response_team.simulation.sec001.phase1.step9.text": "Show me an updated sector situational picture ahead of tonight.",
    "response_team.simulation.sec001.phase1.title": "Readiness Team Incident - Preparation Phase: Routine and Minor Faults",
    "response_team.simulation.sec001.phase2.description": "The transition from routine to emergency: a series of unusual surveillance faults, police indications of a suspicious vehicle, and identification of physical damage to the perimeter fence requiring a callout while short-staffed.",
    "response_team.simulation.sec001.phase2.step1.text": "Good morning. Strange - CAM-01, which we took down yesterday for the update, still hasn't come back. Now CAM-02 next to it is stuck on a frozen image too.",
    "response_team.simulation.sec001.phase2.step2.text": "To the whole area: a report was received of a white commercial vehicle with no license plates, seen moving slowly near your eastern orchards.",
    "response_team.simulation.sec001.phase2.step3.text": "Hey guys, I hear heavy equipment being unloaded near the west gate. Is there planned work there today?",
    "response_team.simulation.sec001.phase2.step4.text": "Give me a quick picture: do we have anything suspicious in the eastern sector? And what's this talk about the west gate?",
    "response_team.simulation.sec001.phase2.step5.text": "Guys, I physically reached CAM-01 on the east fence. There's a physically cut communication cable! This is deliberate sabotage, not a network fault!",
    "response_team.simulation.sec001.phase2.step6.text": "We've located the white commercial vehicle abandoned in the eastern olive grove, about 150 meters from the community fence. Doors open, vehicle empty. Deploying a K9 unit.",
    "response_team.simulation.sec001.phase2.step7.text": "This is a live incident! Cross-reference all the agent information for me immediately, call out the response team, and recommend a force deployment!",
    "response_team.simulation.sec001.phase2.step8.text": "Got the callout, leaving home toward the eastern sector. Arriving within 4 minutes. Who else is with me on the team?",
    "response_team.simulation.sec001.phase2.step9.text": "Reached section 4 east. I can see a fresh breach in the perimeter fence! Footprints leading inward toward the expansion neighborhood!",
    "response_team.simulation.sec001.phase2.title": "Readiness Team Incident - Main Escalation Phase: Heating Up and Accumulating Events",
    "response_team.simulation.sec001.phase3.description": "Reaching the operational edge: suspects breaching the community, false reports causing force dilution, coordinating a complex casualty incident, house-to-house searches, and closing out the incident under an information overload.",
    "response_team.simulation.sec001.phase3.step1.text": "Sirens at the east gate! I saw a suspicious figure in the Levi family's yard at 12 Olive Street! He's got something long in his hand!",
    "response_team.simulation.sec001.phase3.step10.text": "Excellent, the incident is over. Run me a full end-to-end incident summary: timeline, any failures/false reports that occurred, casualty and roster status, and a calming message to distribute to residents.",
    "response_team.simulation.sec001.phase3.step2.text": "Wait! Residents are now reporting continuous gunfire near the west gate! I'm running over there!",
    "response_team.simulation.sec001.phase3.step3.text": "We received a report of a gunshot casualty at the entrance to the expansion neighborhood! Ambulance en route, requesting response-team security for the medical crew.",
    "response_team.simulation.sec001.phase3.step4.text": "I've got total chaos here! Dan is running west because of a gunfire report, MDA is talking about a casualty in the east, and a resident is reporting an armed man in the expansion neighborhood. Sort this out for me right now! Where do I send the available force?!",
    "response_team.simulation.sec001.phase3.step5.text": "Clarification: there is no gunfire at the west gate! The reported gunfire was a warning shot fired by our own patrol car in the eastern orchard area. Do not split forces toward the west!",
    "response_team.simulation.sec001.phase3.step6.text": "I reached 12 Olive Street in the expansion neighborhood! Linked up with MDA, treating the casualty (a resident injured by glass while fleeing). I saw the suspect flee toward the old public building!",
    "response_team.simulation.sec001.phase3.step7.text": "I managed to get a mobile tactical camera up on the office mast! We can see one suspect hiding on the roof of the old public building, holding a dark object in his hand.",
    "response_team.simulation.sec001.phase3.step8.text": "A YASAM unit and a K9 (Yamag) unit are now entering the community grounds. Incident command for the takeover will transfer to us the moment we reach the building.",
    "response_team.simulation.sec001.phase3.step9.text": "Incident under control! The suspect was arrested on the roof without any shots fired. He turns out to be an intruder who tried to flee after cutting the fence. Being transferred for questioning.",
    "response_team.simulation.sec001.phase3.title": "Readiness Team Incident - Extreme Crisis Phase: Active Intrusion, Confusion, and Full Lockdown",
    "response_team.surveillance.camera_id_required": "A camera ID is required to update the observation.",
    "response_team.surveillance.camera_line": "• [{camera_id}] {name} ({area}, {azimuth}°): {feed_summary} [{status}]",
    "response_team.surveillance.camera_status.active": "OK and active {icon}",
    "response_team.surveillance.camera_status.maintenance": "In maintenance {icon}",
    "response_team.surveillance.camera_status.offline": "Offline {icon}",
    "response_team.surveillance.camera_update_done": "Camera observation {camera_id} ({name}) updated successfully {icon}: {feed_summary}",
    "response_team.surveillance.camera_update_failed": "The camera observation update failed: {error}",
    "response_team.surveillance.cameras_header": "{icon} Security camera status ({count} cameras):",
    "response_team.surveillance.default_incident_description": "Operational patrol and surveillance",
    "response_team.surveillance.dispatch_area_required": "A target area must be specified to dispatch the drone.",
    "response_team.surveillance.dispatch_done": "Drone dispatch completed successfully {icon}\n"
        "• Drone: {callsign} ({drone_id})\n"
        "• Target area: {target_area}\n"
        "• Estimated arrival (ETA): ~{eta} seconds\n"
        "• Battery: {battery}% | Mission ID: {mission_id}",
    "response_team.surveillance.dispatch_failed": "The drone dispatch failed: {error}",
    "response_team.surveillance.fleet_header": "{icon} Drone fleet status ({count} drones):",
    "response_team.surveillance.fleet_line": "• [{drone_id}] {callsign} ({model}): {status} | Battery: {battery}% | Area: {area}{mission_info}",
    "response_team.surveillance.fleet_mission_info": " (on mission: {mission_id})",
    "response_team.surveillance.fleet_summary": "Summary: {ready} ready | {in_flight} airborne | {charging} charging",
    "response_team.surveillance.mission_line": "• [{mission_id}] Drone {callsign} ({drone_id}) -> Area: {target_area} "
        "| Battery: {battery}% | ETA: {eta}s | Mission: {description}",
    "response_team.surveillance.missions_header": "{icon} Active airborne drone missions ({count}):",
    "response_team.surveillance.no_cameras": "No active cameras were found in the requested area.",
    "response_team.surveillance.no_drones": "No drones were found in the fleet.",
    "response_team.surveillance.no_missions": "No active drone missions currently in flight.",
    "response_team.surveillance.overview_cameras_line": "• Security cameras: {active}/{total} active and healthy in the area.",
    "response_team.surveillance.overview_drones_line": "• Drone fleet: {ready} ready for dispatch, {in_flight} airborne on mission.",
    "response_team.surveillance.overview_header": "{icon} Overall surveillance picture:",
    "response_team.surveillance.overview_mission_line": "  - Drone {callsign} heading to {target_area} (estimated: {eta}s)",
    "response_team.surveillance.overview_missions_header": "• Airborne missions ({count}):",
    "response_team.surveillance.overview_no_missions": "• Airborne missions: no active airborne missions right now.",
    "response_team.surveillance.recall_all_done": "All drones returned successfully {icon}. All active drones ({count}) returned to base and are ready for duty.",
    "response_team.surveillance.recall_done": "Drone returned to base successfully {icon}. Drone {callsign} ({drone_id}) returned to base and is ready for duty (drone fleet).",
    "response_team.surveillance.recall_done_generic": "Drone returned to base successfully {icon}.",
    "response_team.surveillance.recall_failed": "The drone recall failed: {error}",
    "response_team.surveillance.recall_fallback_done": "Recall command received: drone {callsign} ({drone_id}) is now returning to base to land {icon}.",
    ...
    "response_team.surveillance.status.in_flight": "Airborne on mission {icon}",
    "response_team.surveillance.status.maintenance": "In maintenance {icon}",
    "response_team.surveillance.status.ready": "Ready {icon}",
    ...
    "response_team.surveillance.tool.active_missions": "Returns every currently active airborne mission, including mission ID, drone, target area, and ETA, in Hebrew.",
    "response_team.surveillance.tool.camera_feeds": "Returns the status and picture of security cameras by area or camera ID, in Hebrew.",
    "response_team.surveillance.tool.dispatch_drone": "Dispatches a tactical drone to an area. Only the target_area parameter is required. Every other parameter is entirely optional and must not be requested.",
    "response_team.surveillance.tool.fleet_status": "Returns operational status, battery levels, and locations for the drone fleet, in Hebrew.",
    "response_team.surveillance.tool.overview": "Combined surveillance and airborne picture: cameras, drones, and active missions, in Hebrew.",
    "response_team.surveillance.tool.return_drone": "Returns an active drone to base in a controlled, safe manner, in Hebrew.",
    "response_team.surveillance.tool.update_camera": "Updates a manual observation or status for a security camera, in Hebrew.",
    "response_team.team_status.available_header": "{icon} Available for duty ({count}): {names}",
    "response_team.team_status.awaiting_header": "{icon} Not yet reported ({count}): {names}",
    "response_team.team_status.clarify_availability": "Clarification required: state whether you are available or unavailable.",
    "response_team.team_status.clarify_days": "Clarification required: state how many days you will be unavailable.",
    "response_team.team_status.clarify_reason": "Clarification required: a member who is unavailable must provide a reason.",
    "response_team.team_status.count_summary": "{icon} {available} of {total} team members are currently available.",
    "response_team.team_status.default_original_text": "Availability report: {availability}",
    "response_team.team_status.identity_unavailable": "The response was not recorded: the authenticated user identity is unavailable.",
    "response_team.team_status.keywords.available": "מי זמין|זמינים בלבד|who is available",
    "response_team.team_status.keywords.awaiting": "לא דיווח|טרם דיווח|ממתין|awaiting|pending",
    "response_team.team_status.keywords.count_available": "זמין|available",
    "response_team.team_status.keywords.count_number": "כמה|כמות|how many|count",
    "response_team.team_status.keywords.members": "מי חבר|חברי הכיתה|השמות|מי הם|members|names",
    "response_team.team_status.keywords.reason": "למה|סיבת|reason|why",
    "response_team.team_status.keywords.unavailable": "מי לא זמין|אינם זמינים|unavailable",
    "response_team.team_status.legacy_placeholder_name": "Readiness team member ({identity})",
    "response_team.team_status.marked_available": "{icon} Your availability was updated. You are marked as available for duty.",
    "response_team.team_status.marked_unavailable": "{icon} Your availability was updated. You are marked as unavailable ({reason}).",
    "response_team.team_status.members_header": "{icon} Readiness team members ({count}): {names}",
    "response_team.team_status.no_reason_saved": "no reason was saved",
    "response_team.team_status.none_now": "none right now",
    "response_team.team_status.none_unavailable": "{icon} No team members are currently marked unavailable.",
    "response_team.team_status.not_approved": "The response was not recorded: the user is not an approved readiness-team member.",
    "response_team.team_status.pending_commander_approval": "The report was received and is awaiting commander approval before the readiness status changes.",
    "response_team.team_status.reason_available": "{name} is marked available; there is no active unavailability reason.",
    "response_team.team_status.reason_awaiting": "{name} has not yet reported this cycle; no unavailability reason was saved.",
    "response_team.team_status.reason_unavailable": "{name} is unavailable: {reason}{until}.",
    "response_team.team_status.reason_unknown_member": "Could not confidently identify the requested team member from the roster.",
    "response_team.team_status.reason_until_suffix": " until {until}",
    "response_team.team_status.record_failed": "The response was not recorded: {error}",
    "response_team.team_status.role": "Responsible for managing the readiness team's roster and attendance. Provides availability "
        "reports (who is available/unavailable), and records attendance reports from team members.",
    "response_team.team_status.summary_available_line": "• Available for duty ({count}): {names}",
    "response_team.team_status.summary_awaiting_line": "• Not yet reported ({count}): {names}",
    "response_team.team_status.summary_header": "{icon} Readiness team status (total {count} members):",
    "response_team.team_status.summary_unavailable_line": "• Unavailable ({count}): {names}",
    "response_team.team_status.system_prompt": "You are a specialist agent for readiness-team status management. "
        "You must answer only in short, precise, operational Hebrew (at most 4-5 lines). "
    ...
    "response_team.team_status.tool.get_roster": "Returns only the readiness team's roster picture and members' availability (read-only, no side effects), in Hebrew.",
    "response_team.team_status.tool.record_attendance": "Records a readiness-team member's attendance response, in Hebrew.",
    "response_team.team_status.tool.report_availability": "Returns the real roster data for the current cycle. view is summary, members, available, unavailable, "
        "awaiting, count, or reason; for reason, member_query must also be passed.",
    "response_team.team_status.unavailable_header": "{icon} Unavailable ({count}):",
    "response_team.team_status.unavailable_line": "• {name} — {reason}",
    "response_team.team_status.unnamed_member": "User {identity} (name not set)",
    ...
    "firefighting.simulation.fire002.persona.firefighter_team_a_4": "Team A Firefighter 4 - simulation data",
    "firefighting.simulation.fire002.persona.firefighter_team_a_5": "Team A Firefighter 5 - simulation data",
