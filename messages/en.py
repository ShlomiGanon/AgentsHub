...
=======
    ...
    "firefighting.simulation.fire002.phase1.step1.text": "Good morning. Updating the opening roster: 6 firefighters on Team A, engines Ashed 3 and Carmel 1 fully operational.",
    ...
    "firefighting.simulation.fire002.phase2.step1.text": "Initial smoke detected on camera 05 (Oranim ridge)! Looks like a small fire source in open ground, spreading eastward with the wind.",
    ...
    "firefighting.simulation.fire002.phase2.step4.text": "Camera 05 has gone into thermal confusion due to heavy smoke and glare. The lens is frozen and can't be repositioned remotely.",
    ...
    "firefighting.simulation.fire002.phase2.step7.text": "Show me an urgent situational picture: what's the exact fire location, what's the status of the crews in the field, and what do the agents recommend regarding an emergency callout?",
