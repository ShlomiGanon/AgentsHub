...
MESSAGES = {
    ...
    "admin.server_restart_required": "Loading a profile requires an automatic restart of both the API and the bot.",
    ...
    "admin.server_restarting_help": "The API and bot are being restarted. This page will reconnect automatically.",
    ...
    "admin.api.identity_title": "API execution identity",
    ...
    "admin.api.no_identity": "Register a human Telegram user before calling authenticated API endpoints.",
    "admin.api.identity_help": "Calls are sent to the live public endpoint with this exact X-Identity. Normal permissions and errors still apply.",
    "admin.api.identity_invalid": "The selected API identity is not a registered human user.",
    "admin.api.identity_selected": "API calls will use identity {identity}.",
    ...
    "admin.profiles.subtitle": "Inspect the active profile and change its live settings through the SYSTEM API.",
    ...
    "admin.protocols.subtitle": "List and edit profile protocols through the live Protocol API.",
    ...
    "admin.events.subtitle": "Submit messages and sensor events, inspect jobs and traces, and resolve operational holds through the live API.",
    ...
    "admin.simulator.examples": "Bundled examples",
    "admin.simulator.choose_example": "Choose one of the six examples",
    "admin.simulator.mapping_title": "Map real Telegram identities",
    "admin.simulator.mapping_help": "Map every character and group for this load. Registered server values are suggested, but the exact entered IDs are sent to the real API and are not saved for the next load.",
    "admin.simulator.apply_mapping": "Load with this mapping",
    "admin.simulator.example_invalid": "The selected bundled example is not available.",
    ...
    "admin.simulator.unregistered_name": "Not registered",
