...
MESSAGES = {
    ...
    "admin.simulator.binding_title": "Telegram simulation binding",
    "admin.simulator.binding_help": "Bind one trusted Telegram identity to the exact loaded scenario/run. No latest-run selection is used.",
    "admin.simulator.binding_identity": "Telegram identity",
    "admin.simulator.binding_bind": "Bind loaded exact run",
    "admin.simulator.binding_unbind": "Unbind identity",
    "admin.simulator.binding_bound": "bound to {scenario_id}/{run_id}",
    "admin.simulator.binding_unbound": "unbound",
    "admin.simulator.binding_load_first": "Load an exact provisioned scenario run and enter a Telegram identity first.",
    "admin.simulator.binding_failed": "Binding request failed: {message}",
